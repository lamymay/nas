 ...
 */
@RestController
public class FileBinaryRestController {

    private static final Logger log = LoggerFactory.getLogger(FileBinaryRestController.class);
    ...
    public FileBinaryRestController(MediaService mediaService, SysFileService sysFileService, UrlHelper urlHelper) {
