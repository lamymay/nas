...
public class MockFileServer {
    ...
    private static final Logger log = LoggerFactory.getLogger(MockFileServer.class);
    ...
    public static void main(String[] args) {
        ...
        ConfigurableApplicationContext context = SpringApplication.run(MockFileServer.class, args);
