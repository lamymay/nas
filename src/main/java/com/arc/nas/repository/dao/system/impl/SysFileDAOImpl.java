...
import com.arc.nas.repository.mapper.system.SysFileMapper;
...
import static com.arc.nas.model.constants.DefaultPageParameter.DEFAULT_DB_START_PAGE;
import static com.arc.nas.model.constants.DefaultPageParameter.DEFAULT_PAGE_SIZE;
...
//     优化 分页查询 与 搜索
    ...
    public ArcPage<SysFile> listPage(SysFilePageable pageable) {
        ...
        return new ArcPage(records, total);
    }
